...
public class PixelUnpackBuffer extends Buffer {
    ...
    public boolean equals(final Object object) {
        ...
        final PixelUnpackBuffer other = (PixelUnpackBuffer) object;
    ...
    public String toString() {
        return MoreObjects.toStringHelper(PixelUnpackBuffer.class)
