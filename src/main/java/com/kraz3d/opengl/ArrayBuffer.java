...
public class ArrayBuffer extends Buffer {
    ...
    public boolean equals(final Object object) {
        ...
        final ArrayBuffer other = (ArrayBuffer) object;
    ...
    public String toString() {
        return MoreObjects.toStringHelper(ArrayBuffer.class)
